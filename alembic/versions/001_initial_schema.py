...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("asset_class", sa.Enum("car", "watch", "wine", "whisky", "art", name="assetclass"), nullable=False, server_default="car"),
    ...
    op.create_table(
        ...
        sa.Column("tier", sa.Enum("1", "2", "3", name="colourtier"), nullable=False),
    ...
    op.create_table(
        "data_provenance",
        sa.Column("id", postgresql.UUID(as_uuid=True), primary_key=True),
        sa.Column("source", sa.Enum("bring_a_trailer", "rm_sothebys", "gooding", "bonhams", "cars_and_bids", "dealer_listing", "private_sale", "manual_entry", name="transactionsource"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("transaction_type", sa.Enum("auction_sold", "auction_not_sold", "dealer_listing", "dealer_sold", "private_sale", name="transactiontype"), nullable=False),
        ...
        sa.Column("colour_tier", sa.Enum("1", "2", "3", name="colourtier")),
        sa.Column("condition_grade", sa.Enum("concours", "excellent", "good", "fair", "project", name="conditiongrade")),
    ...
    op.create_table(
        "market_rules",
        sa.Column("id", postgresql.UUID(as_uuid=True), primary_key=True),
        sa.Column("category", sa.Enum("import_eligibility", "tax_treatment", "drive_side", "homologation", "certification", "auction_restriction", "materials_restriction", name="rulecategory"), nullable=False),
        sa.Column("name", sa.String(300), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("id", postgresql.UUID(as_uuid=True), primary_key=True),
        sa.Column("asset_model_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("asset_models.id"), nullable=False),
        sa.Column("signal_type", sa.Enum("momentum", "dealer_auction_spread", "catalyst", "volume_spike", "comparable_appreciation", "pattern_match", name="signaltype"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("status", sa.Enum("watchlist", "actionable", "acquired", "passed", "expired", name="opportunitystatus"), nullable=False, server_default="watchlist"),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
    )
    ...
    op.create_table(
        ...
        sa.Column("status", sa.Enum("watchlist", "actionable", "acquired", "passed", "expired", name="opportunitystatus"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("model_type", sa.Enum("momentum", "fundamental_value", "liquidity", "sentiment", "macro", "rules", name="consensusmodeltype"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("tier", sa.Enum("allocation_access", "secondary_premium", "secondary_standard", name="dealertier"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("id", postgresql.UUID(as_uuid=True), primary_key=True),
        sa.Column("name", sa.String(300), nullable=False, unique=True),
        sa.Column("tier", sa.Enum("major", "mid", "online", name="auctionhousetier"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("asset_model_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("asset_models.id"), nullable=False),
        sa.Column("asset_class", sa.Enum("car", "watch", "wine", "whisky", "art", name="assetclass"), nullable=False, server_default="car"),
        sa.Column("status", sa.Enum("open", "pending_exit", "exited", name="positionstatus"), nullable=False, server_default="open"),
    ...
    op.create_table(
        ...
        sa.Column("cost_category", sa.Enum("acquisition_premium", "auction_buyer_premium", "seller_commission", "transport", "insurance", "storage", "import_duty", "tax", "maintenance", "detailing", "photography", "catalogue_fee", "inspection", "documentation", "other", name="costcategory"), nullable=False),
    ...
    op.create_table(
        "alerts",
        sa.Column("id", postgresql.UUID(as_uuid=True), primary_key=True),
        sa.Column("alert_type", sa.Enum("price_movement", "catalyst", "auction_result", "consensus_change", "holding_cost_warning", "hold_period_warning", "liquidity_warning", "reconciliation_divergence", name="alerttype"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("opportunity_status", sa.Enum("watchlist", "actionable", "acquired", "passed", "expired", name="opportunitystatus")),
